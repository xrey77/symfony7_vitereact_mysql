...
export default function Profile() {    
    ...
    const fetchUserData = async (id: any, token: any) => {
        ...
        await api.get(`/api/getuserid/${id}`,{headers: {
        ...
        .then((res) => {
            ...
            if (res.data.user[0].qrcodeurl === null) {
                ...
                setQrcodeurl(res.data.user[0].qrcodeurl)
            }
            setUserpicture(res.data.user[0].userpic);
            setTimeout(() => {
                setProfileMsg('');
            }, 2000);
        }, (error: any) => {
    ...
    return (
      <div className='profile-bg'>
        <div className="card mt-1 mx-5">
        <div className="card-header bg-success">
            <h3 className="text-white">Profile ID NUMBER : {userid}</h3>
        </div>
        ...
        <form encType="multipart/form-data" autoComplete='false'>
                ...
                <div className='row'>
                    ...
                    <div className='col'>
                        <input className="userpicture mt-2" onChange={changePicture} type="file" name="userpic"/>
                    </div>
                </div>
