    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link text-dark" aria-current="page" to="/about">About Us</Link>
        </li>
    ...
    <div className="offcanvas-body bg-danger">
      ...
      <ul className="nav flex-column">
        <li className="nav-item" data-bs-dismiss="offcanvas">
          <Link className="nav-link text-white embossed " to="/about">About Us</Link>
        </li>
        <li><hr/></li>
        <li className="nav-item dropdown">
          <Link className="nav-link dropdown-toggle text-white embossed" to="/#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Products
          </Link>
          <ul className="dropdown-menu">
        ...
        <li className="nav-item" data-bs-dismiss="offcanvas">
          <Link className="nav-link text-white embossed" to="/contact">Contact</Link>  
        </li>
        <li><hr/></li>
        ...
        <li data-bs-dismiss="offcanvas" className="nav-item">
          <Link className="nav-link text-white embossed" aria-current="page" to="/#" data-bs-toggle="modal" data-bs-target="#staticLogin">Login</Link>
        </li>
        <li><hr/></li>
        <li data-bs-dismiss="offcanvas" className="nav-item">
          <Link className="nav-link text-white embossed" aria-current="page" to="/#" data-bs-toggle="modal" data-bs-target="#staticRegister">Register</Link>
        </li>     
        <li><hr/></li>                 
        </ul>
        ):
